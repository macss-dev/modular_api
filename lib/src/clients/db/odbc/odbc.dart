...
import 'package:modular_api/src/clients/db/odbc/exceptions.dart';
import 'package:modular_api/src/clients/db/odbc/helper.dart';
import 'package:modular_api/src/clients/db/odbc/libodbc.dart';
import 'package:modular_api/src/clients/db/odbc/libodbcext.dart';
      ...
      for (var i = 1; i <= columnCount.value; i++) {
        ...
        if (columnType != null && columnType.isBinary()) {
          ...
          while (!done) {
            ...
            tryOdbc(
              _sql.SQLGetData(
                  hStmt, i, SQL_WCHAR, buf.cast(), bufBytes, columnValueLength),
              handle: hStmt,
              onException: FetchException(),
            );
            ...
            final unitsReturned = (returnedBytes > 0)
