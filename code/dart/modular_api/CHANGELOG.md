...
- **Dart only:** `OTel.initialize` takes a singular `spanProcessor`, and its default exporter speaks
  gRPC. Targeting an OTLP/HTTP Collector means passing `OtlpHttpSpanExporter` explicitly
