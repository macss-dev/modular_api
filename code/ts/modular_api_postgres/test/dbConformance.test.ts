...
const fixture = JSON.parse(
  readFileSync(resolve(process.cwd(), '../../tests/fixtures/db_client/postgres.json'), 'utf8'),
) as Fixture;

describe('db conformance', () => {
  it('matches the shared Postgres connection fixture', () => {
    ...
    expect(settings.sslMode).toBe(fixture.connection.expected.sslMode);
